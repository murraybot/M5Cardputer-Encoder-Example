...
*******************************************************************************
  ...
  在屏幕上显示旋转编码器的值和按键状态
*/
// path: ./Arduino/libraries/M5Cardputer/src/M5Cardputer.h
#include "M5Cardputer.h"
#include <M5GFX.h>
// path: ./Arduino/libraries/M5Unit-Encoder/src/Unit_Encoder.h (modified version in /build in repo)
...
void loop() {
    ...
    canvas.drawString(status, 10, 60);
